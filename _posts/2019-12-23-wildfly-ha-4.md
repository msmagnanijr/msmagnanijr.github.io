...
{% highlight bash %}
[root@monitor ~]# vi /etc/prometheus/alert.rules.yml
...
[root@monitor ~]# chown prometheus:prometheus /etc/prometheus/alert.rules.yml
[root@monitor ~]# promtool check rules /etc/prometheus/alert.rules.yml
[root@monitor ~]# systemctl restart prometheus
{% endhighlight %}
